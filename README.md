...
Anthropic's Claude was used in an assistive capacity for LaTeX formatting, academic writing refinement, and code review support. All technical decisions — architecture, tool selection, model choice, evaluation methodology — were made exclusively by the author. See Section XVIII of the project report for full disclosure.
